...
@Component({
    ...
    imports: [PopupConfirmationComponent, HeaderOperationsButtonsComponent, NzSpinModule, FormsModule, NzFormModule, ReactiveFormsModule, NzCollapseModule, NzLayoutModule, NzInputModule, NzButtonModule, NzIconModule]
})
